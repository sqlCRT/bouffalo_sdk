...
void ui_Screen1_screen_init(void)
{
    ...
    lv_image_set_scale(ui_Image1, 115);

    ui_Image2 = lv_image_create(ui_Screen1);
    lv_image_set_src(ui_Image2, &ui_img_fastforward_png);
    lv_obj_set_width(ui_Image2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Image2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Image2, 216);
    lv_obj_set_y(ui_Image2, -396);
    ...
    lv_obj_set_y(ui_Image4, 404);
    lv_obj_set_align(ui_Image4, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Image4, LV_OBJ_FLAG_CLICKABLE);     /// Flags
    lv_obj_remove_flag(ui_Image4, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_rotation(ui_Image4, 2700);
    lv_image_set_scale(ui_Image4, 160);

    /* Marquee subtitle: this portrait framebuffer is viewed in landscape, so
     * rotate the label like the icons. 780 px leaves a small margin on the
     * 854 px landscape width while keeping the banner readable. */
    ...
    lv_obj_set_width(ui_LabelMarquee, 780);
    lv_obj_set_height(ui_LabelMarquee, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_LabelMarquee, -210);
    ...
    lv_obj_set_width(ui_Slider1, 284);
    lv_obj_set_height(ui_Slider1, 9);
    lv_obj_set_x(ui_Slider1, -39);
    lv_obj_set_y(ui_Slider1, 406);
    ...
    lv_obj_set_x(ui_Image5, -149);
    lv_obj_set_y(ui_Image5, -406);
    ...
    lv_image_set_scale(ui_Image5, 120);
    ...
    lv_image_set_scale(ui_Image6, 180);
    ...
    lv_obj_set_x(ui_Image7, 36);
    lv_obj_set_y(ui_Image7, -406);
