...
void ui_Screen1_screen_init(void)
{
    ...
    lv_image_set_src(ui_Image1, &ui_img_stop_png);
    ...
    lv_image_set_src(ui_Image2, &ui_img_wifi_png);
    lv_obj_set_width(ui_Image2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Image2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Image2, 376);
    ...
    lv_image_set_scale(ui_Image2, 145);

    ui_Image3 = lv_image_create(ui_Screen1);
    lv_image_set_src(ui_Image3, &ui_img_bluetooth_png);
    lv_obj_set_width(ui_Image3, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Image3, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Image3, 375);
    lv_obj_set_y(ui_Image3, -58);
    ...
    lv_obj_set_height(ui_Slider1, 311);
    lv_obj_set_x(ui_Slider1, -375);
    ...
    /* Marquee subtitle: a horizontal banner that scrolls across the top of the
     * panel. Unlike the portrait DSI UIs (UICODE480/UICODE720) this is a NATIVE
     * landscape 800x480 panel, so the label needs NO transform_rotation - it is
     * laid out directly horizontally. Circular scroll is driven by LVGL itself;
     * anim_duration sets the speed (larger = slower). Width is the visible scroll
     * window; height is one text line. */
    ...
    lv_obj_set_width(ui_LabelMarquee, 640); /* visible scroll window */
    lv_obj_set_height(ui_LabelMarquee, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_LabelMarquee, 0);
    lv_obj_set_y(ui_LabelMarquee, -210); /* near the top edge (panel half-height = 240) */
