...
void ui_Screen1_screen_init(void)
{
    ...
    lv_image_set_scale(ui_Image4, 90);
    ...
    lv_image_set_scale(ui_Image7, 110);
    ...
    /* Marquee subtitle: this portrait 172x640 framebuffer is viewed in
     * landscape, so rotate the label like the icons. Keep the font small for
     * the 172 px landscape height. */
    ...
    lv_obj_set_width(ui_LabelMarquee, 580);
    lv_obj_set_height(ui_LabelMarquee, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_LabelMarquee, -70);
